...
exports.index=async(req,res)=>{
    try{
        const tdnfapi=await axios.get(`https://thedigitalnewsfeederapi.herokuapp.com/`)
...
exports.flashnews=async(req,res)=>{
    try{
        const tdnfapi=await axios.get(`https://thedigitalnewsfeederapi.herokuapp.com/news`)
...
exports.flashnewsById=async(req,res)=>{
    try{
        ...
        const tdnfapi=await axios.get(`https://thedigitalnewsfeederapi.herokuapp.com/news/:id`)
...
exports.cricket=async(req,res)=>{
    try{
        const tdnfapi=await axios.get(`https://thedigitalnewsfeederapi.herokuapp.com/cricket`)
...
exports.cricketId=async(req,res)=>{
    try{
        const tdnfapi=await axios.get(`https://thedigitalnewsfeederapi.herokuapp.com/cricket/:{id}`)
        res.render('cricket',{articles:tdnfapi.data})
        //console.log(tdnfapi.data)
    }catch(err){
        if(err.response) {
